...
export default function ProjectCard({project_id, name, description, status, date_created, date_updated}){
	...
	return <>
		<a href={`/projects/${project_id}`} className="shadow card p-3 text-decoration-none">
			...
			<div className="fs-6 fst-italic"><StatusBadge status={status} /></div>
